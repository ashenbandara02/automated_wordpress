                ...
                if deploy_update_scrapper[5] is True:
                    ...
                    if deploy_update_worker == "Cookie fail":
                        ...
                        if wordpress_authentication[0] == True:
                            ...
                            deploy_update_worker = update_product(current_product_id, deploy_update_scrapper[0],
                                                    deploy_update_scrapper[1], deploy_update_scrapper[2],
                    ...
                    if not worked:
                        # Error Occured While Getting Data Failed
                        products_update_fail.append({p_key: [deploy_update_scrapper[0], current_product_id, p_values[2]]})
                        other_errors.append(f"{p_key}: ID-{current_product_id} : <strong>Updating this product was failed by all sites</strong>")
